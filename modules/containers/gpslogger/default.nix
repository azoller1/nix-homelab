{
    virtualisation.oci-containers.containers."geopulse-ui" = {
        ...
        image = "ghcr.io/tess1o/geopulse-ui:1.28.0";
        ports = [ "20002:80" ];
        networks = ["geopulse"];
        ...
        #     "traefik.http.routers.geopulse.middlewares" = "secheader@file,my-robots-txt@file";
    ...
    virtualisation.oci-containers.containers."geopulse" = {
        ...
        image = "ghcr.io/tess1o/geopulse-backend:1.28.0-native";
        networks = ["geopulse"];
        hostname = "geopulse";
